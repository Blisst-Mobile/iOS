...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    BAListObject *listObject = [self.fetchedResultsController objectAtIndexPath:indexPath];
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSSortDescriptor *authorDescriptor = [[NSSortDescriptor alloc] initWithKey:@"completed" ascending:YES];
    NSSortDescriptor *titleDescriptor = [[NSSortDescriptor alloc] initWithKey:@"name" ascending:YES];
